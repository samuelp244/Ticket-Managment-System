    ...
    <div>
      <form onSubmit={submitHandler}>
        ...
        <div className="details">
          ...
          <input type="password" placeholder='Password' value={password} onChange={(e:any)=>{
            setPassword(e.target.value);
          }}/>
          <input type="password" placeholder='Confirm Password' value={confPassword} onChange={(e:any)=>{
